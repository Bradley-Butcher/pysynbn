...
app = typer.Typer(
    name="synbn",
    help="A Python library for generating Synthetic Bayesian Networks",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(f"[yellow]synbn[/] version: [bold blue]{__version__}[/]")
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the synbn package.",
    ),
):
